...
public class CourseManagementPackageImpl extends EPackageImpl implements CourseManagementPackage {
	 ...
	 */
	@Override
	public EReference getStudent_Completed() {
	 ...
	 */
	@Override
	public EReference getServiceFacade_Result() {
	 ...
	 */
	@Override
	public EReference getServiceFacade_Student() {
	 ...
	 */
	@Override
	public EReference getServiceFacade_Course() {
	 ...
	 */
	@Override
	public EReference getServiceFacade_Program() {
	...
	public void createPackageContents() {
		...
		createEReference(studentEClass, STUDENT__COMPLETED);
		...
		createEReference(serviceFacadeEClass, SERVICE_FACADE__RESULT);
		createEReference(serviceFacadeEClass, SERVICE_FACADE__STUDENT);
		createEReference(serviceFacadeEClass, SERVICE_FACADE__COURSE);
		createEReference(serviceFacadeEClass, SERVICE_FACADE__PROGRAM);
	...
	public void initializePackageContents() {
		...
		initEReference(getProgram_Required(), this.getCourseSet(), null, "required", null, 1, 1, Program.class,
		...
		initEReference(getStudent_Transcript(), this.getResult(), null, "transcript", null, 0, -1, Student.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStudent_Completed(), this.getCourseSet(), null, "completed", null, 1, 1, Student.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = initEOperation(getStudent__CanComplete__Course(), ecorePackage.getEBoolean(), "canComplete", 0,
		...
		initEClass(serviceFacadeEClass, ServiceFacade.class, "ServiceFacade", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getServiceFacade_Result(), this.getResult(), null, "result", null, 0, -1, ServiceFacade.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceFacade_Student(), this.getStudent(), null, "student", null, 0, -1, ServiceFacade.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceFacade_Course(), this.getCourse(), null, "course", null, 0, -1, ServiceFacade.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceFacade_Program(), this.getProgram(), null, "program", null, 0, -1, ServiceFacade.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
