...
public class AdvancedImpl extends CourseImpl implements Advanced {
	/**
	 * The cached value of the '{@link #getPrereqs() <em>Prereqs</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPrereqs()
	 * @generated
	...
	public EList<Course> getPrereqs() {
		if (prereqs == null) {
			prereqs = new EObjectContainmentEList<Course>(Course.class, this,
					CourseManagementPackage.ADVANCED__PREREQS);
		}
		return prereqs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case CourseManagementPackage.ADVANCED__PREREQS:
			return ((InternalEList<?>) getPrereqs()).basicRemove(otherEnd, msgs);
		}
	 ...
	 * @generated NOT
	 */
	public boolean isElective(Student student) {
