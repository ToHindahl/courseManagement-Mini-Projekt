 ...
 * </p>
 * <ul>
 *   <li>{@link courseManagement.impl.ResultImpl#getKey <em>Key</em>}</li>
 *   <li>{@link courseManagement.impl.ResultImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultImpl extends MinimalEObjectImpl.Container implements Result {
	...
	protected EClass eStaticClass() {
		return CourseManagementPackage.Literals.RESULT;
	}
		...
		if (key != null && key.eIsProxy()) {
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CourseManagementPackage.RESULT__KEY,
							oldKey, key));
			}
		}
		return key;
	...
	public void setKey(Course newKey) {
		...
		key = newKey;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CourseManagementPackage.RESULT__KEY, oldKey, key));
	}
	...
	public void setValue(Grade newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CourseManagementPackage.RESULT__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CourseManagementPackage.RESULT__KEY:
			if (resolve)
				return getKey();
			return basicGetKey();
		case CourseManagementPackage.RESULT__VALUE:
			return getValue();
		}
